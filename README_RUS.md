...
3. [Реализация функций](#реализация-функций)
   - [Часть 1: Реализация функций библиотеки math.h](#часть-1-реализация-функций-библиотеки-mathh)

## Введение

Проект `s21_math` представляет собой разработку собственной версии математической библиотеки, аналогичной стандартной `math.h`. Это задание направлено на глубокое понимание работы базовых математических функций, их реализации и тестирования.

## Общая информация

В рамках проекта необходимо реализовать основные математические функции, такие как тригонометрические, логарифмические функции, операции с корнями и степенями, а также другие операции, предоставляемые стандартной библиотекой `math.h`.

### Основные требования

- Разработка должна быть выполнена на языке C в соответствии со стандартом C11.
- Реализация должна соответствовать принципам структурного программирования.
- Вся реализация должна быть оформлена в виде статической библиотеки `s21_math.a`.

## Реализация функций

### Часть 1: Реализация функций библиотеки math.h

Необходимо реализовать функции, соответствующие стандартным функциям `math.h`, с соблюдением всех требований по точности вычислений и проверкам корректности входных данных.
